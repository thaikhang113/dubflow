...
python3 scripts/build_linux.py --version 3.0.15
python3 scripts/build_deb.py --no-build --version 3.0.15
```
...
Push a semantic-version tag such as `v3.0.15`. GitHub Actions builds both
