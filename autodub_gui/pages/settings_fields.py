...
FIELDS: tuple[Field, ...] = (
    ...
    Field("DOWNLOAD_URL_WORKERS", NUMBER, "Số luồng tải video", TAB_PERF,
          "Tải video", "3",
          "Tải nhiều liên kết cùng lúc. Tăng quá cao có thể bị giới hạn.",
          minimum=1, maximum=8, step=1, decimals=0),
    Field("DOWNLOAD_FRAGMENT_WORKERS", NUMBER, "Số luồng mảnh tải", TAB_PERF,
          "Tải video", "2",
          "yt-dlp tải nhiều mảnh trong cùng video.",
          minimum=1, maximum=16, step=1, decimals=0),
    Field("DOWNLOAD_PREFETCH_WORKERS", NUMBER, "Số video tải trước", TAB_PERF,
          "Tải video", "2",
          "Batch tải trước vài video trong lúc video hiện tại xử lý.",
          minimum=1, maximum=4, step=1, decimals=0),
    Field("VIDEO2X_ENABLED", CHECK, "Nâng độ phân giải bằng Video2X",
          TAB_PERF, "Video2X", "false",
          "Video2X phải được cài riêng. Lỗi sẽ giữ bản FFmpeg."),
    Field("VIDEO2X_BINARY", TEXT, "Đường dẫn Video2X", TAB_PERF,
          "Video2X", "", "Để trống nếu binary có trong PATH."),
    Field("VIDEO2X_PROFILE", COMBO, "Bộ nâng Video2X", TAB_PERF,
          "Video2X", "realesrgan", "Bộ xử lý Video2X.",
          options=[
    ...
    Field("VIDEO2X_SCALE", NUMBER, "Mức phóng Video2X", TAB_PERF,
          "Video2X", "2", "Mức 2x hoặc 4x.",
          minimum=2, maximum=4, step=2, decimals=0),
    Field("VIDEO2X_MODEL", TEXT, "Model Real-ESRGAN", TAB_PERF,
          "Video2X", "realesr-animevideov3",
          "Dùng khi chọn Real-ESRGAN."),
